...
def detect_similar_invs(data_dir: Path, target_dev_slug: str = None, target_inv_id: str = None, target_inv_slug: str = None):
    ...
    for inv1 in target_invs:
        inv1_id = inv1.get("usi_inv_id") or inv1.get("slug")
        if not inv1_id: continue
        
        dev_slug = inv1.get("developer_slug")
        inv_slug = inv1.get("investment_slug")
        ...
        if new_suggestions:
            ...
            if usi_file:
                ...
                if added:
                    ...
                    inv_index.upsert(data_dir, Path(PUBLIC_USI_DIR), inv_id=inv1_id)
