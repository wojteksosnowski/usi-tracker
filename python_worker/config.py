...
def get_scraper_config():
    ...
    try:
        ...
        # Allow any 1.x.x or 0.9.x version
        if not (current_version.startswith("0.9.") or current_version.startswith("1.")):
            warnings.warn(
                f"USI Scrapers version mismatch! Expected: 1.x.x or 0.9.x, "
