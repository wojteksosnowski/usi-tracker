...
function DashboardGrid({ accent, dark, hereApiKey }) {
  ...
  return (
    <div data-component="DashboardGrid" className="dashboard-content usi-scroll usi-h-full usi-p-24 usi-overflow-auto">
        ...
        {/* Row 3: Top + Postęp — 6+6 kolumny */}
        <BaseModule title="Top inwestycje wg średniej" icon="award" style={{ gridColumn: 'span 6', minHeight: 360 }}>
          {ranked.length === 0 ? (
        ...
        <BaseModule title="Postęp ocen" icon="check-circle" style={{ gridColumn: 'span 6' }}>
...
Object.assign(window, { DashboardGrid, KPI });
